...
/**
 * 组件：实现一个简单的HTTP服务器端，可以获取用户提交的内容 
 * 		并给用户一个response 
 *
 * @author liangancai email：ancai0729@gmail.com
 * @since 2013-2-7 下午4:41:21
 * @version 1.0
 */
public class MyHttpServer {
    ...
    private void doPost(DataInputStream reader, OutputStream out) throws Exception {
    	...
    	while (null != line) {
			...
			} else if (line.indexOf("multipart/form-data") != -1) {//表明要上传附件
    ...
    public static void main(String[] args) throws Exception {
		MyHttpServer server = new MyHttpServer("C:/Users/liangancai/Desktop/www/myhttp", 8080);
		server.service();
	}
}
